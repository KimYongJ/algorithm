//https://www.acmicpc.net/problem/23836
//2초 512MB
//5// 방의 개수(1≤100,000)
//1 2// N-1개 줄에 연결된 노드 정보가 주어짐
//2 3
//3 4
//2 5
//5// 쿼리개수 (1≤100,000)
//1 3 5// 1 u v: 태영이가 주문을 받아, 우유를 u 번 방부터 v 번 방까지 배달합니다.
//1 4 5
//1 1 2
//2 2// 2 x: 태영이가 지금까지 x 번 방에 배달한 우유의 총 개수를 출력합니다.
//2 5
//답 : 2번 쿼리에 대한 답출력
//4
//5
